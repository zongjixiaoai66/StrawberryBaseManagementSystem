...
public class CaomeiOrderEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public CaomeiOrderEntity() {

	}

	public CaomeiOrderEntity(T t) {
		try {
     ...
     * 购买斤数
     */
    @ColumnInfo(comment="购买斤数",type="int(11)")
    ...
    public String toString() {
        return "CaomeiOrder{" +
            ", id=" + id +
            ", caomeiOrderUuidNumber=" + caomeiOrderUuidNumber +
            ", addressId=" + addressId +
            ", caomeiId=" + caomeiId +
            ", yonghuId=" + yonghuId +
            ", buyNumber=" + buyNumber +
            ", caomeiOrderTruePrice=" + caomeiOrderTruePrice +
            ", caomeiOrderCourierName=" + caomeiOrderCourierName +
            ", caomeiOrderCourierNumber=" + caomeiOrderCourierNumber +
            ", caomeiOrderTypes=" + caomeiOrderTypes +
            ", caomeiOrderPaymentTypes=" + caomeiOrderPaymentTypes +
