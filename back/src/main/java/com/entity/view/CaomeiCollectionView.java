...
public class CaomeiCollectionView extends CaomeiCollectionEntity implements Serializable {
	...
	*/
	...
	private String caomeiCollectionValue;
	...
	public CaomeiCollectionView() {

	}

	public CaomeiCollectionView(CaomeiCollectionEntity caomeiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, caomeiCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getCaomeiCollectionValue() {
		return caomeiCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setCaomeiCollectionValue(String caomeiCollectionValue) {
		this.caomeiCollectionValue = caomeiCollectionValue;
	}
	...
	public String toString() {
		return "CaomeiCollectionView{" +
			", caomeiCollectionValue=" + caomeiCollectionValue +
