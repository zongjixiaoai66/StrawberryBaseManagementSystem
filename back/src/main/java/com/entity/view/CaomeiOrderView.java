...
public class CaomeiOrderView extends CaomeiOrderEntity implements Serializable {
	...
	*/
	...
	private String caomeiOrderValue;
	/**
	* 支付类型的值
	*/
	@ColumnInfo(comment="支付类型的字典表值",type="varchar(200)")
	private String caomeiOrderPaymentValue;
	...
	public CaomeiOrderView() {

	}

	public CaomeiOrderView(CaomeiOrderEntity caomeiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, caomeiOrderEntity);
	...
	* 获取： 订单类型的值
	*/
	public String getCaomeiOrderValue() {
		return caomeiOrderValue;
	}
	/**
	* 设置： 订单类型的值
	*/
	public void setCaomeiOrderValue(String caomeiOrderValue) {
		this.caomeiOrderValue = caomeiOrderValue;
	}
	//当前表的
	/**
	* 获取： 支付类型的值
	*/
	public String getCaomeiOrderPaymentValue() {
		return caomeiOrderPaymentValue;
	}
	/**
	* 设置： 支付类型的值
	*/
	public void setCaomeiOrderPaymentValue(String caomeiOrderPaymentValue) {
		this.caomeiOrderPaymentValue = caomeiOrderPaymentValue;
	}
	...
	public String toString() {
		return "CaomeiOrderView{" +
			", caomeiOrderValue=" + caomeiOrderValue +
			", caomeiOrderPaymentValue=" + caomeiOrderPaymentValue +
