...
var centerMenu = [
    ...
    ,{
        name: '草莓收藏',
        url: '../caomeiCollection/list.html'
    }
    ,{
        name: '草莓订单',
        url: '../caomeiOrder/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/zhihuicaomei/admin/dist/index.html#/login";
